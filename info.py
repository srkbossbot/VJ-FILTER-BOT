...
PICS = (environ.get('PICS', 'https://graph.org/file/e9889c55d15afcf2dcd74-479665752c87f2adf2.jpg')).split()
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002365356672').split()]  # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002365356672')).split()]  # For Multiple Id Use One Space Between Each.
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002336298994').split()]  # For Multiple Id Use One Space Between Each.


# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://srkbossbot:srkbossbot@cluster0.kn7bs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
DATABASE_NAME = environ.get('DATABASE_NAME', "srkbossbot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'SRMcollection')
...
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/SRM_Movies_Owner_bot')
